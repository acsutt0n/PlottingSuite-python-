...
![alt tag](https://github.com/acsutt0n/PlottingSuite-python-/subtrees_3d_scatter.png)

* *pretty_2d* 2-D feature plot
Similar to 3-D but ellipses now show all relevant information (no z-dimension to ignore).

![alt tag](https://github.com/acsutt0n/PlottingSuite-python-/paths_2d_scatter.png)
...
![alt tag](https://github.com/acsutt0n/PlottingSuite-python-/violin_example.png)
...
![alt tag](https://github.com/acsutt0n/PlottingSuite-python-/scatter_bench_crosshairs.png)
